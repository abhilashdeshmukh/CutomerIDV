...
<body onload="message()">
	...
	<div id="userinfo" align="left">
		<form id="hubScreenForm" method="post"
			action="${flowExecutionUrl}&_eventId=verify">
			...
			<div align="right" class="buttondiv">
				<input type="submit" value="Verify" class="hubbutton"><input
					type="button" value="Cancel"
					onclick="document.location.href ='${flowExecutionUrl}&_eventId=logoutEntered'"
					class="hubbutton">
			</div>
		</form>
	</div>
